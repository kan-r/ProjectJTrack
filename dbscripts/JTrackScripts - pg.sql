--CREATE USER jtrack WITH PASSWORD 'jtrack';
--CREATE DATABASE jtrackdb WITH OWNER jtrack;
--connect to jtrackdb: \c jtrackdb jtrack
--run sql script: \i 'C:/Working Dir/Projects/JTrack/JTrackScripts - pg.sql'
...
ALTER TABLE PAGE_VISIT_HIST ADD
  CONSTRAINT PAGE_VISIT_HIST_PK
  PRIMARY KEY (HIST_ID);
	
-- DATA -----------------------------------------------------------------------------

INSERT INTO USERS(USER_ID, FIRST_NAME, LAST_NAME, ACTIVE, DATE_CRT)
VALUES('ADMIN', 'Admin', NULL, TRUE, CURRENT_TIMESTAMP);
