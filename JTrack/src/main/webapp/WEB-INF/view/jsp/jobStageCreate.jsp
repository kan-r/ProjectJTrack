<%-- 
    Document   : jobStageCreate
    Created on : 04/07/2013, 9:00:16 PM
    Author     : Kan
--%>
...
<html>
    ...
    <body>
        ...
        <form:form method="POST" action="jobStageCreate.htm">
