<%-- 
    Document   : usersCreate
    Created on : 04/07/2013, 10:52:10 PM
    Author     : Kan
--%>
...
<html>
    ...
    <body>
        ...
        <form:form method="POST" action="usersCreate.htm">
                            ...
                            <table border="0" summary="" >
                                <tr>
                                    ...
                                    <td  colspan="1" rowspan="1" align="left" valign="middle">
                                        <form:input path="userId" onkeyup="this.value = this.value.toUpperCase();" />
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">
