<%-- 
    Document   : timesheetCodeEdit
    Created on : 04/07/2013, 10:00:14 PM
    Author     : Kan
--%>
...
<html>
    <head>
        ...
        <title>Timesheet Code Edit</title>
    </head>
    <body>
        ...
        <form:form method="POST" action="timesheetCodeEdit.htm?id=${timesheetCode}">
                            ...
                            <table border="0" summary="" >
                                <tr>
                                    ...
                                    <td  colspan="1" rowspan="1" align="left" valign="middle">
                                        <form:input path="timesheetCode" readonly="true" class="read-only" />
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">
