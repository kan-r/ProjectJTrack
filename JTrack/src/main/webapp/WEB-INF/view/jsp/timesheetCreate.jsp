<%-- 
    Document   : timesheetCreate
    Created on : 17/07/2013, 9:31:21 PM
    Author     : Kan
--%>
...
<html>
    ...
    <body>
        ...
        <form:form method="POST" action="timesheetCreate.htm">
            <div class="button-region-2">
                <a href="<c:url value="timesheet.htm" />" class="button">Cancel</a>
