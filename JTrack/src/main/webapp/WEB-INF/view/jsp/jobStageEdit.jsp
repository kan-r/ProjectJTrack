<%-- 
    Document   : jobStageEdit
    Created on : 04/07/2013, 9:00:39 PM
    Author     : Kan
--%>
...
<html>
    ...
    <body>
        ...
        <form:form method="POST" action="jobStageEdit.htm?id=${jobStage}">
            <div class="button-region-2">
                <a href="<c:url value="jobStage.htm" />" class="button">Cancel</a>
                            ...
                            <table border="0" summary="" >
                                <tr>
                                    ...
                                    <td  colspan="1" rowspan="1" align="left" valign="middle">
                                        <form:input path="jobStage" readonly="true" class="read-only" />
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">
