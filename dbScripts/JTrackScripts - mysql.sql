...
CREATE TABLE JOB_TYPE(
  ...
  ACTIVE			BOOLEAN,
  DATE_CRT	      	DATETIME DEFAULT CURRENT_TIMESTAMP,
  USER_CRT	      	VARCHAR(20),
  DATE_MOD			DATETIME,
  USER_MOD			VARCHAR(20)
);
...
CREATE TABLE JOB_RESOLUTION(
  JOB_RESOLUTION      	VARCHAR(20) NOT NULL,
...
CREATE TABLE TIMESHEET_CODE(
  TIMESHEET_CODE        VARCHAR(20) NOT NULL,
...
VALUES('ADMIN', 'Admin', NULL, TRUE, CURRENT_TIMESTAMP, 'admin10');
