<%-- 
    Document   : jobEdit
    Created on : 06/07/2013, 10:03:39 PM
    Author     : Kan
--%>
    ...
    <body>
        <div class="header-region">
            <div class="navbar">
                ...
                <div class="navbar-entry"><a href="/login?logout=true">Logout</a></div>
            </div>
        </div>
        ...
        <form:form method="POST" action="jobEdit?id=${jobNo}">
                        ...
                        <td>
                            <table border="0" summary="" >
                                ...
                                <tr>
                                    ...
                                    <td  colspan="1" rowspan="1" align="left" valign="middle">
                                        <form:input path="completedHrs" readonly="true" class="read-only" />
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">
                                ...
                                <tr>
                                    ...
                                    <td  colspan="1" rowspan="1" align="left" valign="middle">
                                        <form:input path="actualStartDate" class="date-field" />
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">
                                ...
                                <tr>
                                    ...
                                    <td  colspan="1" rowspan="1" align="left" valign="middle">
                                        <form:input path="actualEndDate" class="date-field" />
                                    </td>
                                </tr>
                                <tr>
                                    <td nowrap="nowrap" align="right">
